        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium">{farmerData.name}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto p-4 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <TrustBadge type="rating" label={`Credit Score: ${farmerData.creditScore}`} className="bg-white/20 text-white border-white/30" />
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatsCard
            ...
            title="Loan Term"
            value="12 months"
            description="Current active loan"
          />
        </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 border border-border rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">{farmerData.farmSize} • {farmerData.cropType}</p>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                <Button variant="outline" className="w-full justify-start" onClick={handleApplyForLoan}>
                  <CreditCard size={16} className="mr-2" />
                  Apply for Loan
                </Button>
                <Button variant="outline" className="w-full justify-start" onClick={handleUpdateFarmData}>
