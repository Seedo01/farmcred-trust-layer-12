...
import { nigeriaStates, State, LocalGovernment, Ward, Cooperative } from "@/data/nigeriaData";
import { 
  Users, 
  MapPin, 
  TrendingUp, 
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary/20 to-primary/5">
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Manage cooperatives across Nigeria</p>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto p-4 space-y-6">
        ...
        <div className="flex gap-6">
          {["Overview", "Members", "States & LGAs", "Training", "Events"].map((tab) => (
            <button
              key={tab}
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              {ward.cooperatives.length} Cooperatives
                            </p>
                          </div>
                        </div>
                        <ChevronRight size={16} className="text-muted-foreground" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="p-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Basic financial management and loan understanding
                </p>
